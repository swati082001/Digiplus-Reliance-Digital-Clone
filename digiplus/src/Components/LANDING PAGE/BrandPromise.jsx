    ...
    return(
        ...
        <Grid templateColumns="Repeat(4,1fr)" gap={10}>
            <Box width="300px" p={3} border="0.5px solid grey" borderRadius={5} margin="auto" textAlign="center" bg="rgb(247,247,247)">
                ...
                <Text fontSize={14} fontWeight="700" lineHeight="14px"color="#003380">INSTA DELIVERY</Text>
                <Text fontSize={10} color="#666" lineHeight="15px">LESS THAN 3Hrs</Text>
                </Box>
            ...
            <Box width="300px" p={3} border="0.5px solid grey" borderRadius={5} margin="auto" textAlign="center" bg="rgb(247,247,247)">
                ...
                <Text fontSize={14} fontWeight="700" lineHeight="14px"color="#003380">BEST FINANCE OPTIONS</Text>
                <Text fontSize={10} color="#666" lineHeight="15px">WIDE RANGE</Text>
                </Box>
            ...
            <Box width="300px" p={3} border="0.5px solid grey" borderRadius={5} margin="auto" textAlign="center" bg="rgb(247,247,247)">
                ...
                <Text fontSize={14} fontWeight="700" lineHeight="14px"color="#003380">SERVICE GUARENTEE</Text>
                <Text fontSize={10} color="#666" lineHeight="15px">HASSLE FREE</Text>
                </Box>
            ...
            <Box width="300px" p={3} border="0.5px solid grey" borderRadius={5} margin="auto" textAlign="center" bg="rgb(247,247,247)">
                ...
                <Text fontSize={14} fontWeight="700" lineHeight="14px"color="#003380">UNMATCHED NETWORK</Text>
                <Text fontSize={10} color="#666" lineHeight="15px">700 CITIES,2000 STORES</Text>
                </Box>
